...
const Header = ({ siteTitle, isHome }) => (
  <StyledHeader className="background-primary uk-light">
    <div
      id="sticky"
      data-uk-sticky="animation: uk-animation-slide-top; sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky; cls-inactive: uk-navbar-transparent; top: 150"
    >
    ...
    <div className="uk-container uk-margin-top">
      <h2 className="uk-heading-divider">
        Hire an experienced Full Stack Web Developer
      </h2>
      <h5 className="uk-margin-bottom">
        10+ years working with Frontend, Backend and Cloud technology
      </h5>
    </div>
  </StyledHeader>
)
